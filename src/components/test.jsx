...
export default function Test() {
    ...
    // useState Hooks
    const [count, setCount] = useState(0) // 0 = starting value, count = variable, setCount = function
  ...
  return (
    ...
    <div className="w-[400px] h-[300px] shadow-2xl flex flex-col justify-center items-center">
        ...
        <div className="w-full h-[50px] flex justify-center">
            <button className="w-[100px] text-white bg-red-600"
            onClick={
                ()=>{
                    setStatus("🌚")
                }
            ...
            <button className="w-[100px] text-white bg-green-600"
            onClick={
                ()=>{
                    setStatus("🌞") 
                }
